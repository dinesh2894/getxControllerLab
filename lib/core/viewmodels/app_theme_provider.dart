...
import 'package:getx_controller/core/services/init_services/storage_service.dart';
import 'package:getx_controller/core/utils/storage_keys.dart';
...
class AppThemeNotifier extends StateNotifier<ThemeMode> {
  ...
  setUserStoredTheme(ThemeMode themeMode) async {
